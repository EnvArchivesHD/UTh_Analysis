...
class OutputSettingsDialog(QDialog):
    ...
    def initUI(self):
        ...
        self.typeBox.addItem('Speleothem')
        self.typeBox.addItem('Coral')
        self.typeBox.addItem('Other')
        ...
        minLabNrLayout.addWidget(QLabel('First lab number'))
        ...
        maxLabNrLayout.addWidget(QLabel('Last lab number'))
        ...
        layout.addRow(QLabel('Denomination'), self.nameEdit)
        layout.addRow(QLabel('Type of archive'), self.typeBox)
